...
def run_profiler(problem_file: str, output_csv: str, kernels: str, swizzle_size=8) -> bool:
...
def main():
    ...
    for dtype_name in DTYPE_CONFIGS.keys():
        ...
        print("-" * 70)
        print(f"{'N':<6} {'K':<6} {'Tokens':<8} {'EXP':<8} {'Dist':<10} {'Min M':<6} {'Max M':<6} {'swizzle':<6} {'GFLOPS':<10}")
        print("-" * 70)
